    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <h3> Welcome to this client. </h3>
                @if (count($userPosts) <  1)
                    <p> 
                        We need to pull your data from the resource server.
                        Please enter your email and password as used on the resource 
                    </p>

                    <div class="p-5 bg-white" style="width: 600px; max-width: 100%; margin: auto">
                ...
                @else ()
                    <div class="alert alert-success"> 
                            Here are your resources as pulled from the resource server
                    </div>  
